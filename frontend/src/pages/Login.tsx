        ...
        <div className="min-h-screen bg-stone-50 dark:bg-[#0c0a09] flex flex-col items-center justify-center p-4 overflow-y-auto transition-colors duration-300 relative">
            ...
            <div className="w-full max-w-md bg-white dark:bg-[#0f0d0c] border border-stone-200 dark:border-[#2a2725] rounded-2xl p-8 shadow-2xl">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-3xl font-serif text-amber-600 dark:text-amber-500 font-medium tracking-wide">Welcome Back</h1>
                    <p className="text-stone-500 text-sm mt-2">Sign in to The Golden Table</p>
                </div>
                ...
                <div className="mt-10 text-center">
                    <p className="text-stone-500 text-sm">
                        ...
                        <Link to="/signup" className="text-amber-600 dark:text-amber-500 hover:text-amber-500 dark:hover:text-amber-400 font-medium">
                            Create one
                        </Link>
                    </p>
                </div>
